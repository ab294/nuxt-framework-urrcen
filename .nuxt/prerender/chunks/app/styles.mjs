const styles$2 = ":root{--nui-c-context:125,125,125}html{background-color:#fff}html.dark{background-color:#222;color:#fff;color-scheme:dark}";
...
const styles = {
  entry: () => [styles$2, tailwind, __uno],
  "virtual:nuxt:/home/projects/nuxt-framework-urrcen/.nuxt/unocss.mjs": () => import('./_nuxt/unocss-styles.ac8d7a5e.mjs').then(interopDefault),
...
export { __uno as _, styles$1 as s, tailwind as t };
