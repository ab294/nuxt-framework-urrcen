import { getCurrentInstance, reactive, toRef, isRef, inject, defineComponent, computed, ref, h, resolveComponent, unref, version, nextTick, watchEffect, Suspense, Transition, provide, shallowRef, defineAsyncComponent, onErrorCaptured, useSSRContext, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, createElementBlock, createTextVNode, toDisplayString, createApp } from "vue";
...
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderSlot, ssrRenderAttrs, ssrInterpolate, ssrRenderClass } from "vue/server-renderer";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/about.df231192.js").then((m) => m.default || m)
  },
  {
    name: "catchall-id",
    path: "/catchall/:id(.*)*",
    ...
    component: () => import("./_nuxt/_...id_.d53847b6.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index.78e71b76.js").then((m) => m.default || m)
  },
  {
    path: "/parent",
    ...
    children: [
      {
        ...
        component: () => import("./_nuxt/b.7124d16c.js").then((m) => m.default || m)
      },
      {
        name: "parent",
        path: "",
        ...
        component: () => import("./_nuxt/index.147ca981.js").then((m) => m.default || m)
      }
    ],
    meta: meta$2,
    alias: (meta$2 == null ? void 0 : meta$2.alias) || [],
    redirect: (meta$2 == null ? void 0 : meta$2.redirect) || void 0,
    component: () => import("./_nuxt/parent.4fdda76e.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$a = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.a33f279d.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
